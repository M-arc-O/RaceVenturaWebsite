...
import { StageService } from '../../shared';
...
export class StagesEffects {
    ...
    @Effect() loadRaces$ = this.actions$.pipe(
        ...
        switchMap(action => this.stageService.getStages((action as stagesActions.LoadStagesAction).payload)),
    ...
    @Effect() addRace$ = this.actions$.pipe(
        ...
        switchMap(action => this.stageService.addStage((action as stagesActions.AddStageAction).payload)),
    ...
    @Effect() deleteRace$ = this.actions$.pipe(
        ...
        switchMap(action => this.stageService.deleteStage((action as stagesActions.DeleteStageAction).payload)),
    ...
    @Effect() loadRaceDetails$ = this.actions$.pipe(
        ...
        switchMap(action => this.stageService.getStageDetails((action as stagesActions.LoadStageDetailsAction).payload)),
    ...
    @Effect() editRace$ = this.actions$.pipe(
        ...
        switchMap(action => this.stageService.editStage((action as stagesActions.EditStageAction).payload)),
